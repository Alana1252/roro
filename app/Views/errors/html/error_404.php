...
.handle {
    ...
    margin-top: 12px;
    position: absolute;
    right: 31%; /* Atur posisi elemen handle di sebelah kanan */
    top: 42px; /* Posisikan elemen secara vertikal di tengah */
    transform: translateY(-50%); /* Atur posisi elemen secara vertikal di tengah */
    animation: blink 1.2s infinite alternate; /* Terapkan animasi blink */
  }

  .handle:hover {
    width: 14px;
    animation-play-state: paused; /* Hentikan animasi saat dihover */
  }
  ...
  @keyframes blink {
    0% {
      background: #ffe500; /* Warna awal */
    }
    50% {
      background: #000; /* Warna tengah */
    }
    100% {
      background: #ffe500; /* Warna akhir */
    }
  }
...
.button {
  ...
  box-shadow: 0 2px 4px rgba(255, 255, 255, 0.2); /* Ubah warna box shadow menjadi putih */
  font-size: 14px;
  cursor: pointer;
  border: white;
}
...
.button:hover {
  background-color: rgba(255, 255, 255, 0.5); /* Ubah warna latar belakang saat dihover */
}
...
<body>
  ...
  <div class="container">
    <div class="copy-container center-xy" style="margin-top: 60px;">
...
<div class="wrapper"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080"  width="100%" height="750">
<title></title>
